        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/yucradavid/sytemalmacen.git'
                }
            }
        }
        stage('Build') {
